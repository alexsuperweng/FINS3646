...
new_delta  = dt.datetime(year=2023, month=11, day=17, hour=12) - dt.datetime(year=2023, month=11, day=17, hour=0)
print(new_delta)
...
date  =  dt.datetime(year=2023, month=11, day=17, hour=12)
